	...
	return (
		<div className='absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center z-10'>
			<div className='flex justify-center items-center w-[90%] h-[90%]'>
				...
				<div className='self-start w-0 z-20 mt-[1px] cursor-pointer'>
					<span
						className='border-2 pt-0 p-1 border-l-0 rounded-tr-lg rounded-br-lg text-red-500 text-2xl shadow shadow-gray-500 modal-close-btn bg-gray-800 border-purple-800'
						onClick={closeModal}
					/>
				</div>
			</div>
